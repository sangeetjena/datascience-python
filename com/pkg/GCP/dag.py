...
with models.DAG(
    ...
    bq_recent_questions_query = bigquery_operator.BigQueryOperator(
        ...
        bql="""
            insert my_dataset.titanic_output select Sex,count(1) from my_dataset.titanic x group by sex
            """,
    ...
    hello_python >> create_dataproc_cluster >> dataprod_pyspark >> delete_dataproc_cluster >> bq_recent_questions_query >> goodbye_bash